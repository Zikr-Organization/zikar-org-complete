        ...
        <div class="container">
          <div class="row news">
            ...
            <div class="col-sm-12 col-xs-12 news-color">
              ...
              <div class="col-md-2 col-md-offset-2 col-sm-6 col-xs-12 border4">
                <div class="newsletter">
                  <form action="#">
                    <div class="input-group" style={{paddingLeft:'19px'}}>
                      <input
                        type="email"
                        class="form-controls"
          ...
          <div class="row">
            <div class="col-md-3 col-sm-6">
              <div class="contact-logo">
                <a href="index.html">
                  <a href="index.html">
                    <img src={logo} class="img-responsive logo" alt="img" style={{ marginLeft:'105px'  }} />
                  </a>
                </a>
